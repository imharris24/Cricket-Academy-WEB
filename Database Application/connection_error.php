...
<head>
    ...
    <title>Connection ERROR - Cricket Academy</title>
        ...
        <div id="content">
            <div class="container-fluid">
                <div class="text-center mt-5">
                    ...
                    <p class="text-dark mb-5 lead">Connection Error</p>
                    <p class="text-black-50 mb-0">Unable to Connect with Database</p>
                </div>
            </div>
        </div>
