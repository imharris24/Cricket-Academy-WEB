<?php session_start(); include ('check_connection.php'); ?>
<html>

<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no">
    <title>Register User - Cricket Academy</title>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 fw-bold" style="border-color: #009977;color: #009977;">Register New User</p>
                    </div>
                    <div class="card-body">
                        <form method="post" action="process_register_user.php">
                            <label class="form-label"><strong>User ID </strong><em>(Must be unique)</em></label><input class="form-control" type="text" name="front_user_id">
                            <hr><label class="form-label"><strong>Name</strong><br></label><input class="form-control" type="text" name="front_user_name">
                            <hr><label class="form-label"><strong>Email</strong><br></label><input class="form-control" type="email" name="front_user_email">
                            <hr><label class="form-label"><strong>Date of Birth</strong></label><input class="form-control" type="date" name="front_user_dob">
                            <hr><label class="form-label"><strong>Nationality</strong></label><input class="form-control" type="text" name="front_user_nationality">
                            <hr><label class="form-label"><strong>Password</strong></label><input class="form-control" type="password" name="front_user_password">
                            <hr><label class="form-label"><strong>User Type</strong></label><input class="form-control" type="text" name="front_user_type">
                            <hr><label class="form-label"><strong>Player Role </strong><em>(Only enter if user is cricket player)</em></label><input class="form-control" type="text" name="front_player_role">
                            <hr><label class="form-label"><strong>Player Batting Style </strong><em>(Only enter if user is cricket player)</em></label><input class="form-control" type="text" name="front_player_batting_style">
                            <hr><label class="form-label"><strong>Player Bowling Style </strong><em>(Only enter if user is cricket player)</em></label><input class="form-control" type="text" name="front_player_bowling_style">
                            <hr><label class="form-label"><strong>Player Coach ID </strong><em>(Only enter if user is cricket player)</em></label><input class="form-control" type="text" name="front_player_coach_id">
                            <hr><label class="form-label"><strong>Coach Role  </strong><em>(Only enter if user is cricket coach)</em></label><input class="form-control" type="text" name="front_coach_role">
                            <hr><label class="form-label"><strong>Designation  </strong><em>(Only enter if user is staff member)</em></label><input class="form-control" type="text" name="front_staff_designation">
                            <hr><button class="btn btn-primary" type="submit" style="text-align: center;">Register User</button>
                        </form>
                    </div>
                </div>
            </div>
