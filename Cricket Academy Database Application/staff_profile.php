...
<head>
    ...
    <title>Staff Profile - Cricket Academy</title>
                    ...
                    <ul class="navbar-nav flex-nowrap ms-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <div class="nav-item dropdown show no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="true" data-bs-toggle="dropdown" href="#"><img class="border rounded-circle img-profile" src="assets/img/avatars/images.png?h=4cf6ea1278652efbecfd6ec680662850"></a>
                                <div class="dropdown-menu show shadow dropdown-menu-end animated--grow-in"><a href="staff_profile.php" class="dropdown-item"><i class="fas fa-user fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Profile</a>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 fw-bold" style="border-color: #009977;color: #009977;">Profile</p>
                    </div>
                    <div class="card-body">
                        <?php
                        ...
                        <?php
                        $sql = "SELECT * FROM staff WHERE user_id=\"$_SESSION[USER]\"";
                        $result = mysqli_query($conn, $sql);
                        $row = mysqli_fetch_assoc($result);
                        ?>
                        <h6><b>Designation: </b> <?php ECHO $row['designation'] ?></h6><br>
                    </div>
                </div>
            </div>
        </div>
