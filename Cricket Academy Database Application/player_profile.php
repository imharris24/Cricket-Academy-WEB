            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 fw-bold" style="border-color: #009977;color: #009977;">Player Profile</p>
                    </div>
                    <div class="card-body">
                        <?php
                        ...
                        <?php
                        $sql = "SELECT * FROM player WHERE user_id=\"$_SESSION[USER]\"";
                        $result = mysqli_query($conn, $sql);
                        $row = mysqli_fetch_assoc($result);
                        ?>
                        <h6><b>Role: </b> <?php ECHO $row['role'] ?></h6><br>
                        <h6><b>Batting Style: </b> <?php ECHO $row['batting_style'] ?></h6><br>
                        <h6><b>Bowling Style: </b> <?php ECHO $row['bowling_style'] ?></h6><br>
                    </div>
                </div>
            </div>
        </div>
